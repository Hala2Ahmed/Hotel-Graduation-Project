...
export default function Footer() {
  return (
    <footer className="bg-secondaryDarkColor text-white py-12 overflow-hidden">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="pr-0 md:pr-5">
            <p className="mb-4">
              <span className="block text-mainColor">Address:</span>
              <span>
                198 West 21th Street, <br /> Suite 721 New York NY 10016
              </span>
            </p>
            <p className="mb-4">
              <span className="block text-mainColor">Phone:</span>
              <span>(+1) 435 3533</span>
            </p>
            <p>
              <span className="block text-mainColor">Email:</span>
          ...
          <div>
            ...
            <form action="#" className="flex items-center">
              <input
                type="email"
                className="form-control p-2 flex-grow bg-[#27272A] text-white"
                placeholder="Email..."
              />
              <button type="submit" className="bg-mainColor text-white p-2">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-5">
          <p className="text-center md:text-left mb-4 md:mb-0">
            ...
            <a className="text-mainColor">team</a>
          </p>
